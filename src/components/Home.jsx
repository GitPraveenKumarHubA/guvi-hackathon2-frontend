...
export const Home = () => {
  ...
  const getMovies = () => {
    axios.get("https://guvi-hackathon2-backend-heroku.onrender.com/movies").then((res) => {
      console.log(res.data);
      setRecommended(res.data);
    });
    axios.get("https://guvi-hackathon2-backend-heroku.onrender.com/entertainment").then((res) => {
      console.log("Ent", res.data);
      setEntertainment(res.data);
    });
    axios.get("https://guvi-hackathon2-backend-heroku.onrender.com/premiere").then((res) => {
      console.log("Ent", res.data);
      setPremiere(res.data);
    });
    axios.get("https://guvi-hackathon2-backend-heroku.onrender.com/laughter").then((res) => {
      console.log("Ent", res.data);
